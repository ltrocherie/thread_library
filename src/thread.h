...
struct thread{
  ...
  STAILQ_HEAD(thread_waiting_list, thread) thread_waiting_list;
};
...
STAILQ_HEAD(thread_runqueue, thread) thread_runqueue;
STAILQ_HEAD(thread_deadstack, thread) thread_deadstack;
...
typedef struct thread_mutex {
    int is_initialized;
    thread_t thread_locker;
    STAILQ_HEAD(mutex_waiting_list, thread) mutex_waiting_list;
} thread_mutex_t;
